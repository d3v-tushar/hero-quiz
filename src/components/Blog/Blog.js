...
const Blog = () => {
    return (
        ...
        <div className='grid justify-items-center mt-5'>
            ...
            <div className="card md:w-10/12 glass text-neutral-content my-5">
            <div className="card-body items-center">
                <h2 className="card-title text-2xl">1. What is the purpose of react router?</h2>
            ...
            <div className="card md:w-10/12 glass text-neutral-content my-5">
            <div className="card-body items-center">
                <h2 className="card-title text-2xl">3. What is UseRef? How does it work? </h2>
